...
{ 
    ...
    Shader* shader_specularmap_normalmap = Engine.shaderManager->Load("data/shaders/specularmap_normalmap.shader");
    Shader* shader_normalmap_cubemap = Engine.shaderManager->Load("data/shaders/normalmap_cubemap.shader");
    ...
    auto cubemap_sky = new Cubemap(
        "data/skybox/tex_sb1_right.png",
        "data/skybox/tex_sb1_left.png",
        "data/skybox/tex_sb1_top.png",
        "data/skybox/tex_sb1_bottom.png",
        "data/skybox/tex_sb1_front.png",
        "data/skybox/tex_sb1_back.png"
        );
    ...
    */
    ...
    auto tex_crate_normal = new Texture("data/textures/norm_crate.png", 3);
    auto tex_crate_specular = new Texture("data/textures/spec_crate.png", 3);
    auto mat_crate = new Material(shader_normalmap_cubemap, tex_crate, tex_crate_specular, tex_crate_normal);
    mat_crate->cubemap = cubemap_sky;
    ...
    */
    ...
    light->color = vec3(0.75f, 0.75f, 0.75f);
    ...
    // auto obj_particles_manager = new ParticlesManager();
    // scene->Add(obj_particles_manager);
